...
$testnumber = $_GET['t'];
$testinfo = mysql_query("SELECT * FROM tests WHERE testid='$testnumber'");
$studentid = $sesuser['id'];
$checkstudent = mysql_query("SELECT * FROM testscores WHERE testid='$testnumber' AND studentid='$studentid'");
$checkstudent2 = mysql_num_rows($checkstudent);
?>
<!doctype html>
<html>
<head>
...
<div style="width: 85%; margin: auto; position: relative; top: 100px;">
	...
	if ($checkstudent2 == "0") {
		...
		while ($test = mysql_fetch_assoc($testinfo)) {
