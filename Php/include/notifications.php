...
<div id="notificationsmodal" class="modal">
    <div class="modal-content">
		...
		<ul class="collection">
			...
			<?php
				$userid = $sesuser['id'];
				$notifications = mysql_query("SELECT * FROM notifications WHERE userid = '$userid'");
				$message = '';
				$action = '';
				while ($notification = mysql_fetch_assoc($notifications)) {
					getInfo((int) $notification['user_from']);
					...
					echo '
						<li class="collection-item dismissable" id="not'.$notification['id'].'">
							<img src="'.$user_info['avatar'].'" class="circle">
							<span class="title">'.$user_info['first_name'].' '.$user_info['last_name'].'</span>
							<p>'.$message.'
							</p>
