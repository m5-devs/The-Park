...
//Delete old messages
$db->query("DELETE FROM messages WHERE timestamp < (NOW() - INTERVAL 720 HOUR)");
$user1 = $sesuser['id'];
$messages = $db->select("SELECT * FROM instant WHERE userid ='$user1' AND userid2 ='$user2' or userid ='$user2' AND userid2 ='$user1' ORDER BY id ASC ");
$time = '';
$id = '';
